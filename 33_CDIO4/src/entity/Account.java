...
public class Account {
	 ...
	 * 
	 * @param balance
	 *            The start balance of the account..
	 */
	 ...
	 * 
	 * @param value
	 *            The value that the balance of the account should be changed
	 *            with. If the parameter is positive the method adds value to
	 *            the balance. If the parameter is negative the method subtracts
	 *            value from balance.
	...
	/**
	 * OBS: This method is only used for testing. Method setBalance sets the
