...
public class Street extends Ownable {
	 ...
	 * @param colour
	 *            The specific colour of the field on the board.
	 * @param baseRent
	 *            The base rent of the unbuilt field.
	 * @param houseRent
	 *            The base rent of the empty field.
	 * @param numbOfHouses
	 *            The current number of houses built on the field.
	 * @param pledge
